...
k8s-sidecar)
    ...
    copy_image_to_cluster "${K8S_IMAGE_REPO}"/csi-attacher:v3.2.1 "${K8S_IMAGE_REPO}"/csi-attacher:v3.2.1
    copy_image_to_cluster "${K8S_IMAGE_REPO}"/csi-snapshotter:v4.1.1 $"${K8S_IMAGE_REPO}"/csi-snapshotter:v4.1.1
    copy_image_to_cluster "${K8S_IMAGE_REPO}"/csi-provisioner:v2.2.2 "${K8S_IMAGE_REPO}"/csi-provisioner:v2.2.2
    copy_image_to_cluster "${K8S_IMAGE_REPO}"/csi-node-driver-registrar:v2.2.0 "${K8S_IMAGE_REPO}"/csi-node-driver-registrar:v2.2.0
    copy_image_to_cluster "${K8S_IMAGE_REPO}"/csi-resizer:v1.2.0 "${K8S_IMAGE_REPO}"/csi-resizer:v1.2.0
    ;;
clean)
    ${minikube} delete
    ;;
